...
public class Warrior extends Job {
    ...
    protected void initializeAbilities() {
        ...
        Ability club = new PhysicalAbility("Club", 2, 1, 1,
                18, .70, "Club a neighbouring enemy on the head with low accuracy");
        Ability powerUp = new StatusEffectAbility("Power UP!", 4, 1, 1,
                StatusEffectAbility.StatusType.ATTACK_BUFF, "Buff the attack of a neighbouring ally");
        Ability stone = new PhysicalAbility("Stone", 1, 4, 1,
                8, .60, "A low chance to damage an enemy from afar");
